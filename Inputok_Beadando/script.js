const KepekLista = ["axolt, capibara, golya, kameleon, lajhar, lama, macska, mokus, nyuszi, oroszlan, panda, papagaj, pava, roka, suni, tehen"];
...
function createCards(num){
    ...
    const rand = random(1,17); // Random szám, 1-16 között
    for(let i = 0; i < num; i++){
        const li = `<img src="kepek/${KepekLista[rand]}.jpg"> </img>`
        ul += `<li>${li}</li>`;
    }
}
